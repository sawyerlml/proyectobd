...
<div class="page-content">
    ...
    <h4 class="text-center text-secondary">REGISTRAR NUEVO USUARIO</h4>
    ...
    <div class="row">
      <form action="" method="POST">
        ...
        <div class="text-right p-2">
          ...
          <button type="submit" value="ok" name="btnregistrar" class="btn btn-primary btn-rounded">Resgistrar</button>
        </div>
      </form>
    </div>
