...
?>
    ...
    <a href="registro_usuario.php" class="btn btn-primary btn-rounded mb-1"> <i class="fa-solid fa-plus"></i> &nbsp;Registar</a>
    <table class="table table-bordered table-hover col-12 w-100" id="example">
  <thead>
    <tr>
      <th scope="col">ID</th>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header d-flex justify-content-between">
        <h5 class="modal-title w-100" id="exampleModalLabel">Modal Usuario</h5>
      ...
      <div class="modal-body">
          ...
          <div hidden class ="fl-flex-label mb-4 px-2 col-12" >
            ...
            <div class="text-right p-2">
              <a href="usuario.php" class="bnt btn-secondary btn-rounded">Atras</a>
